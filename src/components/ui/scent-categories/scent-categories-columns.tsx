...
import { type ScentCategory } from "./scent-category-table"
...
export function getColumns({ handleDeleteScentCategory, handleEditScentCategory }: ColumnProps) {


    const columns: ColumnDef<ScentCategory>[] = [
        {
                ...
                return (
                    <div className="flex items-center w-full justify-center">
                        <Button className="bg-red-600 bg-opacity-60 rounded-2xl" onClick={(e) => {
                            e.stopPropagation();
                            handleDeleteScentCategory(cell.row.original)
                        }}>
