    ...
    return (
        ...
        >
            ...
            >
                ...
                <Button className='bg-custom-accentLight hover:bg-red-600 hover:bg-opacity-70 rounded-xl' onClick={() => onConfirm(formulation.id)}>Confirm <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
