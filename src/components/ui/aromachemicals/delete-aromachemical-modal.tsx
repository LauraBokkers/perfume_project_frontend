...
const DeleteModal = ({ onClose, onConfirm, aromachemical }: ModalPropType) => {
    ...
    return (
        <div
            id="mail-modal"
            className={"fixed inset-0 z-50 mx-2 flex items-center justify-center backdrop-brightness-50"}
            onClick={() => onClose()}
        >
            <div
            ...
            >
                ...
                <Button className='bg-custom-accentLight hover:bg-red-600 hover:bg-opacity-70 rounded-xl' onClick={() => onConfirm(aromachemical.id)}>Confirm <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
