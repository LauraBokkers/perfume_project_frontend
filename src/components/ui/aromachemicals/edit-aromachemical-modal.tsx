...
import { OdorStrength, OdorStrengthSchema, Persistence, PersistenceSchema, Solvent, SolventSchema, Supplier, SupplierSchema, type Aromachemical } from "./aromachemicals-table";
                    ...
                    <div className="flex flex-col items-start gap-4 mb-10 mt-4">
                        ...
                        <div className="flex flex-row gap-2 min-w-fit">
                            {scentCategories.map((scentCategory, idx) => (
                                <div key={idx} className="text-sm p-2 rounded-md text-white bg-blue-500">
